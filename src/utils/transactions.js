...
const WEI_IN_DEAM = 1e18;

/**
 * @return {number}
 */
export function WEIToDEAM(_value) {
    return (_value / WEI_IN_DEAM);
}

/**
 * @return {number}
 */
export function DEAMToWEI(_value) {
    return _value * WEI_IN_DEAM;
}
 ...
 * @return {number}
 */
export function DEAMToUSD(_value, _tokenPrice = 0.002) {
