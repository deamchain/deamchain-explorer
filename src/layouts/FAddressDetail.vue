                    ...
                    <div class="balance center-v">
                        <h3 class="h1">
                            <span v-show="cAccount">
                                <MyTokenValue :value="cAccount ? cAccount.totalValue : 1" convert no-currency /> <span class="deam">DEAM</span>
                            </span>
                        </h3>
                    ...
                    <div class="balance center-v">
                        <h3 class="h1">
                            <span v-show="'available' in cAssets">
                                <MyTokenValue :value="cAssets.available" convert no-currency /> <span class="deam">DEAM</span>
                            </span>
                        </h3>
                    ...
                    <div class="row no-collapse">
                        ...
                        <div class="col">
                            <div v-show="'claimed_rewards' in cAssets">
                                -
                                <!--{{ toDEAM(cAssets.claimed_rewards, true) }} DEAM-->
                            </div>
                        </div>
                    </div>
                    <div class="row no-collapse">
...
<script>
    ...
    import { WEIToDEAM, DEAMToUSD } from "../utils/transactions.js";
...
/*
                dAssetColumns: [
                    ...
                    {
                        name: 'valueInDEAM',
                        label: this.$t('view_address_detail.value_in_deam'),
                        cssClass: 'align-end',
                    },
                    {
                        name: 'valueInUSD',
                ...
                if (cAccount) {
                    ...
                    if (delegations && delegations.edges) {
                        delegations.edges.forEach((_edge) => {
                            ...
                            assets.delegated += (delegation ? WEIToDEAM(delegation.amount) : 0);
                            assets.pending_rewards += (delegation && delegation.pendingRewards ? WEIToDEAM(delegation.pendingRewards.amount) : 0);
                            assets.claimed_rewards += (delegation ? WEIToDEAM(delegation.claimedReward) : 0);
                        });
...
/*
            getAssetItem(_assetName, _value) {
                return {
                    asset: _assetName,
                    balance: this.toDEAM(_value),
                    valueInDEAM: this.toDEAM(_value),
...
*/
             ...
             * @return {string}
             */
            toDEAM(_value, _isNumber) {
                return _isNumber ? _value : WEIToDEAM(_value);
            },
             ...
             */
            toUSD(_value) {
                return DEAMToUSD(WEIToDEAM(_value), this.$store.state.tokenPrice);
            },
