        ...
        <f-card>
            <template v-if="!dTransactionByHashError">
                ...
                <div class="row no-collapse">
                    ...
                    <div class="col"><div class="break-word" v-show="cTransaction">{{  WEIToDEAM(cTransaction.value) }} DEAM</div></div>
                </div>
                <!--
                            <div class="row no-collapse">
                                <div class="col-4 f-row-label">{{ $t('view_transaction_detail.fee') }}</div>
                                <div class="col"><div class="break-word" v-show="cTransaction">{{  WEIToDEAM(cTransaction.fee) }} DEAM</div></div>
                            </div>
                -->
                <div class="row no-collapse">
                ...
                <div class="row no-collapse">
                    ...
                    <div class="col"><div class="break-word" v-show="cTransaction">{{  cTransactionFee }} DEAM</div></div>
                </div>
                <div class="row no-collapse">
    ...
    export default {
        ...
        computed: {
            ...
            cTransactionFee() {
                ...
                if (transaction) {
                    return WEIToDEAM(this.formatHexToInt(transaction.gasPrice) * this.formatHexToInt(transaction.gasUsed));
                }
