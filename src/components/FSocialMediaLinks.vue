<template>
    <ul class="f-social-media-links no-markers">
        <li>
            <a href="https://t.co/rUA9BE8kf2?amp=1" target="_blank" rel="nofollow" title="DEAM on Discord">
                <icon data="@/assets/svg/social-media/discord.svg" width="24" height="24"></icon>
            </a>
        </li>
        <li>
            <a href="https://twitter.com/DEAMFDN" target="_blank" rel="nofollow" title="DEAM on Twitter">
                <icon data="@/assets/svg/social-media/twitter.svg" width="24" height="24"></icon>
            </a>
        </li>
        <li>
            <a href="https://www.reddit.com/r/DEAMFoundation/" target="_blank" rel="nofollow" title="DEAM on Reddit">
                <icon data="@/assets/svg/social-media/reddit.svg" width="24" height="24"></icon>
            </a>
        </li>
        <li>
            <a href="https://github.com/DEAM-Foundation" target="_blank" rel="nofollow" title="DEAM on Github">
                <icon data="@/assets/svg/social-media/github.svg" width="24" height="24"></icon>
            </a>
        </li>
        <li>
            <a href="https://medium.com/DEAMfoundation" target="_blank" rel="nofollow" title="DEAM on Medium">
                <icon data="@/assets/svg/social-media/medium.svg" width="24" height="24"></icon>
            </a>
        </li>
        <li>
            <a href="https://www.linkedin.com/company/DEAM-foundation/" target="_blank" rel="nofollow" title="DEAM on Linkedin" class="linkedin">
