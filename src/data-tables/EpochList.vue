    ...
    data() {
        return {
            ...
            dColumns: [
                ...
                /*{
                    name: 'baseReward',
                    label: this.$t('epoch.total_base_reward') + ' (DEAM)',
                    itemProp: 'epoch.totalBaseRewardWeight',
                    formatter: (_value) => formatNumberByLocale(WEIToDEAM(_value), 1, 2),
                    cssClass: 'align-end',
                },*/
                {
                    name: 'fee',
                    label: this.$t('epoch.total_fee') + ' (DEAM)',
                    itemProp: 'epoch.epochFee',
                    formatter: (_value) => WEIToDEAM(_value),
                    cssClass: 'align-end',
                },
                /*{
                    name: 'txReward',
                    label: this.$t('epoch.total_tx_reward') + ' (DEAM)',
